...
grant_funder_990_overview(funder_name,ein,ntee_code,city,state,most_recent_filing_year,total_revenue_cents,total_expenses_cents,total_assets_end_cents,total_liabilities_end_cents,contributions_gifts_grants_cents,program_revenue_cents,pdf_only_filing_years,source_url,fetched_at,error) — ProPublica 990-PF summary financials per foundation/corporate funder, one row per funder_name
`.trim();
